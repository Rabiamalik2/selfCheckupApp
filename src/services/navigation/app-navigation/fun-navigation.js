...
const FunNavigation = () => {
  return (
    <Stack.Navigator screenOptions={options}>
      <Stack.Screen
        name={funNavRoutes.funEduScreen}
        component={TabNavRoutes.TabNavRoutes.FunEduScreen}
      />
      <Stack.Screen
        name={funNavRoutes.healthEduScreen}
        component={FunNavRoutes.FunNavRoutes.HealthEduScreen}
      />
      <Stack.Screen
        name={funNavRoutes.liveActivityScreen}
        component={FunNavRoutes.FunNavRoutes.LiveActivityScreen}
      />
      <Stack.Screen
        name={funNavRoutes.yogaActivityScreen}
        component={FunNavRoutes.FunNavRoutes.YogaActivityScreen}
      />
    </Stack.Navigator>
  );
};
