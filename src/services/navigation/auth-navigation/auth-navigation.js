...
const AuthNavigation = () => {
    return (
        <Stack.Navigator screenOptions={options}>
            <Stack.Screen name={authRoutes.welcomeScreen} component={AuthRoutes.WelcomeScreen} />
            ...
            <Stack.Screen name={authRoutes.choosePicScreen} component={AuthRoutes.ChoosePicScreen} />
            <Stack.Screen name={authRoutes.signinWithPhoneScreen} component={AuthRoutes.SiginInWithPhoneScreen} />
            <Stack.Screen name={authRoutes.otpPhoneScreen} component={AuthRoutes.OtpPhoneScreen} />
        </Stack.Navigator>
    );
}
