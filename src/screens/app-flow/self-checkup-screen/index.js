...
const SelfCheckupScreen = (props) => {
    return (
      ...
      >
        ...
        <Text style={styles.subTxt}>Chest discomfort feels like as pain, {'\n'} or fullness, and/or squeezing {'\n'} sensations of the chest?</Text>
        </View>
        <View style={styles.parent}>
            <View style={styles.child}>
                <View style={styles.viewS2}>
                    <View style={styles.btnView}>
                        <TouchableOpacity style={styles.btnToStyle} 
                            onPress={()=> props.navigation.navigate('selfCheckNavigator', {screen : 'questionScreen1'})}>
                            <Text style={styles.btnTxtStyle}>Yes</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.btnView1}>
                        <TouchableOpacity style={styles.btnToStyle1} 
                        onPress={() => Alert.alert("Your situation is under control. keep checking in daily.")}>
