        ...
        <View style={styles.childView}>
          <View style={styles.viewS2}>
            ...
            <Text style={styles.item}>
              You now have access to a wide range of features and resources
              designed to support your health journey. Take advantage of our
              self-checkup questionnaires, vital signs tracking, educational
              materials, and engaging activities. We are here to empower you on
              your path to a healthier lifestyle.
            </Text>
            <Text style={styles.item}>
              Thank you for choosing the Self Health Check App. We look forward
              to accompanying you on this transformative journey towards
